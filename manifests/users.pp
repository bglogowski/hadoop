define hadoop::users ( $username ) {
  ...
  file { "/home/${username}/.bashrc":
    ...
    mode    => '0755',
    backup  => false,
    content => template("hadoop/users/${username}/bashrc.erb"),
    require => File["/home/${username}/"],
  }
  ...
  file { "/home/${username}/.ssh/authorized_keys":
    ...
    group   => $username,
    mode    => '0640',
    content => template("hadoop/users/${username}/authorized_keys.erb"),
  ...
  file { "/etc/security/limits.d/${username}.conf":
    ...
    group   => 'root',
    mode    => '0644',
    content => template("hadoop/users/${username}/limits.conf.erb"),
  }
